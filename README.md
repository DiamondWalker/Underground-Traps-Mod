...
3. In `src/main/java/com/example/UndergroundTraps`, fill out the `MODID`, `NAME`, and `VERSION` strings again, and move the class to your own package (not `com.example`).
